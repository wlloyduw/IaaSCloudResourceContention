...
cachebench_option = sys.modules[__name__].cachebench_option = ' -r -x0 -d2 -e1'
cachebenchw_option = sys.modules[__name__].cachebenchw_option = ' -w -x0 -d2 -e1'
cachebenchb_option = sys.modules[__name__].cachebenchb_option = ' -b -x0 -d2 -e1'
