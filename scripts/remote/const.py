...
sysbench_option = sys.modules[__name__].sysbench_option = ' --test=cpu --threads=2 --events=10 --cpu-max-prime=2000000 run'
...
cachebench_option = sys.modules[__name__].cachebench_option = ' -r -x0 -e1'
cachebenchw_option = sys.modules[__name__].cachebenchw_option = ' -w -x0 -e1'
cachebenchb_option = sys.modules[__name__].cachebenchb_option = ' -b -x0 -e1'
